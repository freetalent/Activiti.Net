...
namespace Activiti.Net.Models
{
    ...
    public partial class Operation
    {
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "inMessageRef")]
        public string InMessageRef { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "outMessageRef")]
        public string OutMessageRef { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "errorMessageRef")]
        public IList<string> ErrorMessageRef { get; set; }
